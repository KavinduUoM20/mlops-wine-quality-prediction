...
```bash
https://github.com/KavinduUoM20/mlops-wine-quality-prediction
```
...
export MLFLOW_TRACKING_URI=https://dagshub.com/KavinduUoM20/mlops-wine-quality-prediction.mlflow
